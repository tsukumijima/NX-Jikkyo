        ...
        <main>
            ...
            <div class="channels-container channels-container--home" :class="{'channels-container--loading': is_loading}">
                <p class="mt-5 mx-4 text-center">
                    ...
                    <a class="link" href="https://github.com/tsukumijima/KonomiTV/releases/tag/v0.10.1" target="_blank">KonomiTV 0.10.1</a> / <a class="link" href="https://blog.tsukumijima.net/article/nx-jikkyo-released/#toc3" target="_blank">TVTest (NicoJK master-240613)</a> にて NX-Jikkyo の表示に対応しました！<br>
