        ...
        async init() {
            ...
            recorded_program.detail = {
                '過去ログ再生について': (
                    ...
                    '2009年11月から現在までの 旧ニコニコ実況 (~2020/12/14)・ニコ生統合後の新ニコニコ実況 (~2024/06/08)・ニコニコ実況 (Re:仮) (~2024/08/05)・公式生放送での暫定復旧版ニコニコ実況 (~2024/08/22)・NX-Jikkyo (2024/06/10~) の過去ログコメントを再生できます。\n\n' +
