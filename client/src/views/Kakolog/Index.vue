        ...
        <main>
            ...
            <div class="px-5 py-8" style="width: 100%; max-width: 850px; margin: 0 auto; line-height: 1.65;">
                ...
                <p class="mt-4 text-text-darken-1">
                    <strong><a class="link" href="https://jikkyo.tsukumijima.net" target="_blank">ニコニコ実況 過去ログ API</a> に保存されている、2009年11月から現在までの 旧ニコニコ実況 (~2020/12/14)・ニコ生統合後の新ニコニコ実況 (~2024/06/08)・ニコニコ実況 (Re:仮) (~2024/08/05)・公式生放送での暫定復旧版ニコニコ実況 (~2024/08/22)・NX-Jikkyo (2024/06/10~) のすべての過去ログを、チャンネルと日時範囲を指定して再生できます。</strong><br>
                </p>
