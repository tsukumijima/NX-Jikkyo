<template>
    ...
    <SettingsBase>
        ...
        <div class="settings__content" :class="{'settings__content--loading': is_loading}">
            ...
            <div class="settings__item settings__item--switch">
                <label class="settings__item-heading" for="show_comment_type">コメントリストにタイプ（ニコ実/NX）を表示する</label>
                <label class="settings__item-label" for="show_comment_type">
                    この設定をオンにすると、コメントリストの各コメントにコメントの投稿元（ニコ実 / NX）が表示されます。
                </label>
                <v-switch class="settings__item-switch" color="primary" id="show_comment_type" hide-details
