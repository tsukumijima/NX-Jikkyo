    ...
    <div class="watch-player" :class="{
        ...
        <div class="watch-player__button"
            ...
            <div v-ripple class="switch-button switch-button-up"
                ...
                @click="playerStore.is_zapping = true; $router.push({path: `/watch/${settingsStore.settings.tv_channel_up_down_buttons_reverse ? channelsStore.channel.next.display_channel_id : channelsStore.channel.previous.display_channel_id}`})">
            ...
            <div v-ripple class="switch-button switch-button-down"
                    ...
                    @click="playerStore.is_zapping = true; $router.push({path: `/watch/${settingsStore.settings.tv_channel_up_down_buttons_reverse ? channelsStore.channel.previous.display_channel_id : channelsStore.channel.next.display_channel_id}`})">
